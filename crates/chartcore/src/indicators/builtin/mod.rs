...
// Total: 79+ indicators across 7 categories

// === Scientific Indicators (3) ===
pub mod lempel_ziv;
...
// Re-exports - Scientific Indicators
pub use lempel_ziv::LempelZivComplexity;
...
pub use smi_ergodic::{SMIErgodicIndicator, SMIErgodicOscillatorIndicator};
...
pub use adr::{ADRIndicator, ADRPercentIndicator};
...
pub fn get_builtin_plugins() -> Vec<Arc<dyn IndicatorPlugin>> {
    vec![
        ...
        Arc::new(SMIErgodicOscillatorIndicator::default()),
        ...
        Arc::new(ADRPercentIndicator::default()),
